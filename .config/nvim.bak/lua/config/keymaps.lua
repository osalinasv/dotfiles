...
keymap.map({ "n", "v" }, "<M-k>", "<cmd>m-2<CR>==", "Move line up")
keymap.map({ "n", "v" }, "<M-j>", "<cmd>m+<CR>==", "Move line down")
...
-- Move windows
keymap.map("n", "<C-S-h>", "<C-w>h", "Window left")
keymap.map("n", "<C-S-l>", "<C-w>l", "Window right")
keymap.map("n", "<C-S-k>", "<C-w>k", "Window up")
keymap.map("n", "<C-S-j>", "<C-w>j", "Window down")
...
keymap.map({ "n", "v" }, "<C-j>", "<C-d>", "Move down 1/2 screen")
keymap.map({ "n", "v" }, "<C-k>", "<C-u>", "Move up 1/2 screen")
